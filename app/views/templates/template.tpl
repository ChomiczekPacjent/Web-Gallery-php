                ...
                <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
                    <div class="u-nav-container">
                        <ul class="u-nav u-unstyled u-nav-1">
                            ...
                            {if $logged_user->login == 'Nexo'}
    <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="{$conf->action_root}users" style="padding: 10px 20px; color: white; font-size: 20px;">Users</a></li>
{/if}
                            {/if}
                        </ul>
                    </div>
